...
const Billing = { template: '<div class="section billing"><router-view></router-view></div>' };
...
const Patients = { template: '<div class="section patients"><router-view></router-view></div>' };
...
const Payments = { template: '<div class="section payments"><router-view></router-view></div>' };
...
const Reports = { template: '<div class="section reports"><router-view></router-view></div>' };
import ReportsView from '../components/pages/reports/View.vue';

const Scheduler = { template: '<div class="section scheduler"><router-view></router-view></div>' };
...
const Tools = { template: '<div class="section tools"><router-view></router-view></div>' };
